...
class FakeGit(object):
    ...
    def __init__(self):
        parser = argparse.ArgumentParser(
            ...
            usage='''pyrpipe_diagnostic <command> [<args>]
                    The commands are:
...
def report():
    ...
    parser.add_argument('-e', help='report output type: [MD,PDF] \ndefault: PDF',action="store")
    parser.add_argument('-c',help='Report options [(s)ummary only,(f)ull,fa(i)l,(p)ass]\ndefault: f',action="store")
