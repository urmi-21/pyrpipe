...
class testSpecs:
    def __init__(self):
        ...
        self.cdna=testfiles+"/genome/Arabidopsis_thaliana.TAIR10.cdna.50.fa"
        self.cdna_big=testfiles+"/genome/Arabidopsis_thaliana.TAIR10.cdna.5000.fa"
        self.cdna_small=testfiles+"/genome/Arabidopsis_thaliana.TAIR10.cdna.5.fa"
        ...
        self.portcullisBam=testfiles+"/mapping/portcullis.bam"
